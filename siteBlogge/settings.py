...
WSGI_APPLICATION = 'siteBlogge.wsgi.application'
NOTIFICATION_MODEL = 'post_app.post'
...
STATIC_URL = 'static/'
MEDIA_URL = 'media/'
STATICFILES_DIRS = [os.path.join("assets"), os.path.join("static")]
MEDIA_ROOT = os.path.join(BASE_DIR, "imega")
# STATIC_ROOT = ("assets")
